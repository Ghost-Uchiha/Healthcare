...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid ">
    <div class="navbar-header">       
     <a class="navbar-brand text-dark" href="#myPage"><strong>Healthcare</strong></a>
...
<li><a href="doctor_schedule_list.php">Booking Appointment</a></li>

<li><a href="Users/view_users_appointment.php">My Appointments</a></li>
        </ul>
        </li>
  ...
  <li class="dropdown">
          ...
          <ul class="dropdown-menu"> 
<li><a href="Users/doctor_schedule_list.php">Consulting Hour</a></li>
